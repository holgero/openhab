 ...
 * @since 0.1.0
 */
public class SerialBusBinding extends AbstractActiveBinding<SerialBusBindingProvider> implements ManagedService {

	private static final Logger logger = 
		LoggerFactory.getLogger(SerialBusBinding.class);
